...
<body id="home">
    ...
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			<h1 class="h1_home wow fadeIn" data-wow-delay="0.4s">Pelatih.id</h1>
			<h3 class="h3_home wow fadeIn" data-wow-delay="0.6s">an easy ways to get skill</h3>
			<ul class="list-inline intro-social-buttons">
				<li><a href="https://play.google.com" class="btn  btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">Get in Google Play</span></a>
				</li>
				<li id="download" ><a href="<?php echo base_url('index.php/login') ?>" class="btn  btn-lg mybutton_standard wow swing wow fadeIn" data-wow-delay="1.2s"><span class="network-name">Login/Sign Up</span></a>
				</li>
			</ul>
		</div>    
        <!-- /.container -->
