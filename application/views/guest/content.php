		...
		<div class="container">
			...
			<div class="row wow fadeInUp">
				<div class="col-lg-3 col-md-6">
					<div class="member">
						<div class="pic"><img src="<?php echo base_url('img/team/team-1.jpg')?>" alt=""></div>
						<h4>Walter White</h4>
				...
				<div class="col-lg-3 col-md-6">
					<div class="member">
						<div class="pic"><img src="<?php echo base_url('assets/img/team/team-2.jpg')?>" alt=""></div>
						<h4>Sarah Jhinson</h4>
				...
				<div class="col-lg-3 col-md-6">
					<div class="member">
						<div class="pic"><img src="<?php echo base_url('assets/img/team/team-3.jpg')?>" alt=""></div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="member">
						<div class="pic"><img src="<?php echo base_url('assets/img/team/team-4.jpg')?>" alt=""></div>
						<h4>Amanda Jepson</h4>
