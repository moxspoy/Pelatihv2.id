...
<section id="intro">
	...
	<div class="intro-text">
		<h2>Pelatih.id</h2>
		<p>You are in best place to find your match trainer, instructor, and mentor to get skill</p>
	...
	<div class="product-screens">
		...
		<div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
			<img src="<?php echo base_url('assets/img/product-screen-1.png')?>" alt="">
		</div>

		<div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
			<img src="<?php echo base_url('assets/img/product-screen-2.png')?>" alt="">
		</div>

		<div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
			<img src="<?php echo base_url('assets/img/product-screen-3.png')?>" alt="">
		</div>
	...
	<section id="advanced-features">
				...
				<div class="row">
					<div class="col-12">
						<img class="advanced-feature-img-right wow fadeInRight"
							 src="<?php echo base_url('assets/img/advanced-feature-1.jpg')?>" alt="">
		...
		<div class="features-row">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<img class="advanced-feature-img-left"
							 src="<?php echo base_url('assets/img/advanced-feature-2.jpg')?>" alt="">
		...
		<div class="features-row section-bg">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<img class="advanced-feature-img-right wow fadeInRight"
							 src="<?php echo base_url('assets/img/advanced-feature-3.jpg')?>" alt="">
						<div class="wow fadeInLeft">
							<h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
							<h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
	...
	<section id="team" class="section-bg">
		<div class="container">
			<div class="section-header">
				...
				<span class="section-divider"></span>
				<p class="section-description">
					People behind Pelatih.id
				</p>
			</div>
			<div class="row wow fadeInUp">
				<div class="col-lg-4 col-md-6">
					<div class="member">
						<div class="pic"><img src="https://yt3.ggpht.com/a-/AJLlDp2c--FeEvsnv5GJ6nuTh3vAJatJF1xZ6Pa9=s900-mo-c-c0xffffffff-rj-k-no" alt=""></div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="member">
						<div class="pic"><img src="https://scontent.fcgk9-2.fna.fbcdn.net/v/t31.0-1/c228.0.960.960/p960x960/26232631_1731024086918959_4047146794839557180_o.jpg?_nc_cat=0&_nc_eui2=AeGMHa9GMYib26azemnLUJoQstOOzQVg90BMPl4SZ8g2pWINBBuELZLHu3dGyvCvEJSZahXxAUS7S9-PmoJP1ZDkOUiqZ0P542hXOMQLB-tI_dvH6zCUjxRFRIBP5IsslUI&oh=635fb03d26124ae2e16886dbde2011ea&oe=5C288D0F" alt=""></div>
						<h4>Lintang Dhanasmoro</h4>
						<span>Product Manager</span>
						<div class="social">
							<a href=""><i class="fa fa-twitter"></i></a>
							<a href="https://web.facebook.com/lintang.dhanasmoro"><i class="fa fa-facebook"></i></a>
							<a href=""><i class="fa fa-google-plus"></i></a>
							<a href=""><i class="fa fa-linkedin"></i></a>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="member">
						<div class="pic"><img src="https://pbs.twimg.com/profile_images/740200338121056256/IDH70Nd6.jpg" alt=""></div>
						<h4>Dwi Nurfitria Bella</h4>
